...
namespace d14engine::uikit::appearance
{
    ...
    _D14_SET_THEME_STYLE_MAP_IMPL(LabelArea);

    void LabelArea::Appearance::changeTheme(WstrParam themeName)
    {
        _D14_FIND_THEME_STYLE(themeName);

        _D14_UPDATE_THEME_STYLE_DATA_1(hiliteRange.background.color);
        _D14_UPDATE_THEME_STYLE_DATA_1(indicator.background.color);
    }
}
