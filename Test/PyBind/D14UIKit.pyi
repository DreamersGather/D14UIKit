...
class Application:
    ...
    def addThreadCallback(self, id: int, callback: Callable[[int], None]) -> None: ...
    def capture(self, *args, **kwargs): ...
    def exit(self) -> None: ...
    def removeThreadCallback(self, id: int) -> None: ...
    def run(self) -> int: ...
    def setThreadEvent(self, id: int, data: int = ...) -> None: ...
    @property
...
class Panel:
    ...
    def moveAbove(self, uiobj: Panel) -> None: ...
